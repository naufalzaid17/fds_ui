...
const AlertAcquirerConfiguration = () => {
  ...
  const { id, acquirer, terminalId } = router.query;
  const [selectedKeyForce, setSelectedKeyForce] = useState(null);

  const {dataTransaction, handleGetTransaction} = GetTransactionSummary(terminalId);
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (IS_ALERTED) => (
        <>
        {IS_ALERTED === 1 ? (
          <Tag color='blue' text="Non Locked" key={IS_ALERTED} className='text-red'>
            TRUE
          </Tag>
        ) : (
          <Tag color='red' text="Locked" key={IS_ALERTED}>
            FALSE
          </Tag>
        )
        }
  ...
  return (
    <Layout>
    <HeadTitle title="Alert Acquirer Configuration"/>
    <HeadContent pageTitle="Alert Acquirer Configuration" caption="More details and actions for alert Acquirer."/>
              ...
              <div className="w-full h-full border-[1px] border-secondary p-6 rounded-md flex flex-col ">
                <div className="h-[30rem] flex flex-col gap-4 overflow-y-auto">
                  {Array.isArray(dataHistory) && dataHistory.map((item) => (
                    <>
                      <div className="p-2 border-l-4 rounded-md border-fourd w-fit pr-8 bg-fourd bg-opacity-10">
                        <div className="rounded-xl">
                          <div className="text-[1rem] flex flex-col rounded-xl px-1">
                            ...
                            <span className="text-[0.75rem] w-full">
                ...
                <form>
                    <div className="w-full h-full pt-8 flex items-center">
                        <div className="relative w-full">
                            ...
                            <input
                              type="text"
                              className="w-full bg-[#F2F2F2] py-3 rounded-l text-sm px-12"
                              placeholder="Comment..."
                        ...
                        <button className="bg-primary text-white px-5 py-4 rounded-r" onClick={handleClassify} disabled={isButtonDisabled}>
                                ...
                                {dataClassify.map((item) => (
                                    <>
                                        <div
                                            ...
                                            onClick={() => [setmenu(false), setallocate(false), setreply(!reply),setforce(false), handleCardClick(item.value, item)]} id={item.key} 
                                        >
                                          {item.key === 1 ? (
                                            <Image
        ...
        <form className='font-poppins mt-5 font-medium'>
            <div className="text-sm">
                ...
                <div className="mt-4">
                    ...
                    <input className=" w-full border-secondary border-[1px] mt-[11px] md:mt-2 rounded-lg py-2 px-2 focus:outline-green-700" value={terminalId} readOnly/>
                </div>
                <div className="mt-4">
                    <label className="">Comment</label>
                    <input className=" w-full border-secondary border-[1px] mt-[11px] md:mt-2 rounded-lg py-2 px-2 focus:outline-green-700"/>
...
export default AlertAcquirerConfiguration